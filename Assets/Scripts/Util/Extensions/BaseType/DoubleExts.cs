...
namespace Util
{
    public static class DoubleExts
    {
        ...
        /// 按精度判断float相等
        /// </summary>
        public static bool IsEqualPrecision(this float @this, float compare, double epsilon = 1e-7)
        {
            return Math.Abs(@this - compare) < epsilon;
        }

        /// <summary>
        /// 按精度取float的天花板
        /// </summary>
        public static int ToCeilingPrecision(this float @this, double epsilon = 1e-7)
        {
            return (int)Math.Ceiling(@this - epsilon);
        }

        /// <summary>
        /// 按精度取float的地板
        /// </summary>
        public static int ToFloorPrecision(this float @this, double epsilon = 1e-7)
        {
            return (int)Math.Floor(@this + epsilon);
        }
    }
}