...
namespace Util
{
    public static class TransformExts
    {
        ...
        public static void SetRotateX(this Transform @this, float newValue)
        {
            Vector3 v = @this.rotation.eulerAngles;
            v.x = newValue;
            @this.rotation = Quaternion.Euler(v);
        }
        public static void SetRotateY(this Transform @this, float newValue)
        {
            Vector3 v = @this.rotation.eulerAngles;
            v.y = newValue;
            @this.rotation = Quaternion.Euler(v);
        }
        public static void SetRotateZ(this Transform @this, float newValue)
        {
            Vector3 v = @this.rotation.eulerAngles;
            v.z = newValue;
            @this.rotation = Quaternion.Euler(v);
        ...
        public static void HideAllChild(this Transform @this)
        {
            if (@this == null)
                return;
        ...
        public static void SetActive(this Transform @this, bool isActive)
        {
            if (@this == null)
                return;
