...
namespace Util
{
    public static partial class Utility
    {
        ...
        public static class Algorithm
        {
            ...
            /// <returns></returns>
            public static float MapSection(float minf, float maxf,float curf, int min, int max)
            {
                if (curf <= minf)
                {
                    return min;
                ...
                return  ((max - min) * (curf - minf) / (maxf - minf));
            }

            
            public static float FMapSection(float minf, float maxf,float curf, int min, int max)
            {
                if (curf <= minf)
                {
                    return min;
            ...
            public static string ConcatStr(List<string> list, string s)
            {
