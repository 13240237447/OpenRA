...
namespace Util
{
    ...
    class CoroutineQueue
    {
        ...
        readonly Func<IEnumerator, UnityEngine.Coroutine> coroutineStarter;
        ...
        public CoroutineQueue(uint maxActive, Func<IEnumerator, UnityEngine.Coroutine> coroutineStarter)
        {
            if (maxActive == 0)
