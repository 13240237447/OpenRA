...
namespace Util
{
    ...
    {
        public UnityEngine.Coroutine PredicateCoroutine(Func<bool> handler, Action callBack)
        {
        ...
        public UnityEngine.Coroutine PredicateNestCoroutine(Func<bool> predicateHandler, Action nestHandler)
        {
            return StartCoroutine(EnumPredicateNestCoroutine(predicateHandler, nestHandler));
        }
        public UnityEngine.Coroutine DelayCoroutine(float delay, Action callBack)
        {
            return StartCoroutine(EnumDelay(delay, callBack));
        }
        public UnityEngine.Coroutine StartCoroutine(Action handler)
        {
            return StartCoroutine(EnumCoroutine(handler));
        }
        public UnityEngine.Coroutine StartCoroutine(Action handler,Action callback)
        {
        ...
        public UnityEngine.Coroutine StartCoroutine(UnityEngine.Coroutine routine, Action callBack)
        {
        ...
        IEnumerator EnumCoroutine(UnityEngine.Coroutine routine, Action callBack)
        {
