...
public class WeaponListController : MonoBehaviour {
	...
	public WeaponConf GetWeapon() {
		...
		&& weaponList[selectedWeaponIndex].rightArmAnimAim != null) {
			weaponList[selectedWeaponIndex].rightArmAnimator.Play(weaponList[selectedWeaponIndex].rightArmAnimAim.name);
		}
	...
	public WeaponConf GetWeaponForStats() {
	...
	public void WeaponShootAnimation() {
		...
		//Execute aim animation
		if(weaponList[selectedWeaponIndex].rightArmAnimator != null
		&& weaponList[selectedWeaponIndex].rightArmAnimShoot != null) {
			weaponList[selectedWeaponIndex].rightArmAnimator.Play(weaponList[selectedWeaponIndex].rightArmAnimShoot.name);
		}
