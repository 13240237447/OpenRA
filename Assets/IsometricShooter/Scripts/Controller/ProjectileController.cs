...
public class ProjectileController : MonoBehaviour {
	...
	void Start () {
		...
		if(projectileConf.muzzleFlash != null) {
			GameObject mf = Object.Instantiate(projectileConf.muzzleFlash.gameObject, projectileConf.muzzleFlash.transform.position, projectileConf.muzzleFlash.transform.rotation) as GameObject;
		...
		if(projectileConf.muzzleSteam != null) {
			GameObject ms = Object.Instantiate(projectileConf.muzzleSteam.gameObject, projectileConf.muzzleSteam.transform.position, projectileConf.muzzleSteam.transform.rotation) as GameObject;
	...
	public void Init(Vector3 aimPos) {
		...
		if(projectileConf.isBallistic) {
			...
			direction = new Vector3(Random.Range(direction.x-tolerance, direction.x+tolerance),
									direction.y, 
									Random.Range(direction.z-tolerance, direction.z+tolerance));
		}
